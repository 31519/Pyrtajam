  ...
  return (
    <>
      ...
      <div className={style.container}>
        ...
        <p>Welcome to pyrtajam!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Pyrtajam Website, located at www.pyrtajam.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use pyrtajam if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing pyrtajam, you agreed to use
          cookies in agreement with the Pyrtajam Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Pyrtajam and/or its licensors own the
          intellectual property rights for all material on pyrtajam. All
          intellectual property rights are reserved. You may access this from
          pyrtajam for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from pyrtajam</li>
          <li>Sell, rent or sub-license material from pyrtajam</li>
          <li>Reproduce, duplicate or copy material from pyrtajam</li>
          <li>Redistribute content from pyrtajam</li>
        </ul>
        ...
        <p>
          ...
          Pyrtajam does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Pyrtajam,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Pyrtajam shall
        ...
        <p>
          Pyrtajam reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Pyrtajam a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Pyrtajam; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Pyrtajam. Please include your name, your
        ...
        <p>
          No use of Pyrtajam logo or other artwork will be allowed for linking
