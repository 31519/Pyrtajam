  ...
  return (
    <>
      ...
      <div className={style.container}>
        <h1>Privacy Policy for Pyrtajam</h1>

        <p>
          At pyrtajam, accessible from www.pyrtajam.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by pyrtajam and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in pyrtajam. This policy is not applicable to
        ...
        <p>
          pyrtajam follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, pyrtajam uses cookies. These cookies are used
        ...
        <p>
          ...
          advertising partners of pyrtajam.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on pyrtajam, which are sent
        ...
        <p>
          Note that pyrtajam has no access to or control over these cookies that
        ...
        <p>
          pyrtajam Privacy Policy does not apply to other advertisers or
        ...
        <p>
          pyrtajam does not knowingly collect any Personal Identifiable
